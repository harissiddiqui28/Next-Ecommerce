...
const Footer: React.FC = () => { return (
    ...
    <div className=' w-400 mt-8 mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300 bg-black'>
      ...
      <Image src="/images/nav.png" alt="Logo" width={100} height={100} />
      ...
      <div className='lg:col-span-2 flex justify-between mt-6 flex-col md:flex-row'>
    <div>
    ...
    <div>
        <h6 className=' border-green-700 bg-green-700 font-bold text-white'>Become a Vendor</h6>
        <ul>
